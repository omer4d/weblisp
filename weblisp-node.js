...
$$root["default-lexenv"]=(function(){
   var $$TMP579;
   $$TMP579=(function(__GS37){
      var $$TMP580;
$$root["seti!"](__GS37,"this",true);
$$TMP580=__GS37;
return $$TMP580;
}
)($$root["object"]());
...
$$root["seti!"]($$root["node-evaluator-proto"],(new $$root.Symbol("init")),(function(){
   var $$TMP581;
   $$TMP581=(function(self){
      var $$TMP582;
      $$TMP582=(function(root,sandbox){
         var $$TMP583;
...
$$root["seti!"](root,"jeval",(function(str){
   var $$TMP584;
$$TMP584=$$root["call-method-by-name"]($$root["VM"],(new $$root.Symbol("runInContext")),str,sandbox);
return $$TMP584;
}
));
$$TMP583=(function(__GS38){
   var $$TMP585;
$$root["seti!"](__GS38,"root",root);
$$root["seti!"](__GS38,"compiler",$$root["make-instance"]($$root["compiler-proto"],root));
$$TMP585=__GS38;
return $$TMP585;
}
)(self);
...
$$root["seti!"]($$root["node-evaluator-proto"],(new $$root.Symbol("eval")),(function(expr){
   var $$TMP586;
   $$TMP586=(function(self){
      var $$TMP587;
      $$TMP587=(function(tmp){
         var $$TMP588;
$$TMP588=$$root["call-method-by-name"]($$root["geti"](self,(new $$root.Symbol("root"))),(new $$root.Symbol("jeval")),$$root["str"]($$root["second"](tmp),$$root["first"](tmp)));
return $$TMP588;
}
...
$$root["seti!"]($$root["node-evaluator-proto"],(new $$root.Symbol("eval-str")),(function(s){
   ...
   $$TMP589=(function(self){
      var $$TMP590;
      $$TMP590=(function(forms){
         var $$TMP591;
         $$TMP591=(function(__GS39,__GS40,form){
            var $$TMP592;
            $$TMP592=(function(recur){
               var $$TMP593;
               recur=(function(){
                  var $$TMP594;
                  var $$TMP595;
                  var $$TMP596;
if($$root["not"]($$root["null?"](__GS40))){
   $$TMP596=true;
}
else{
   $$TMP596=false;
...
if($$TMP596){
   $$TMP595=(function(){
      var $$TMP597;
form=$$root["car"](__GS40);
form;
__GS39=$$root["call-method-by-name"](self,(new $$root.Symbol("eval")),form);
__GS39;
__GS40=$$root["cdr"](__GS40);
__GS40;
$$TMP597=recur();
return $$TMP597;
}
...
$$root["seti!"]($$root["lazy-def-proto"],(new $$root.Symbol("init")),(function(compilation__MINUSresult){
   ...
   $$TMP599=(function(self){
      var $$TMP600;
$$TMP600=$$root["seti!"](self,(new $$root.Symbol("code")),$$root["str"]($$root["second"](compilation__MINUSresult),$$root["first"](compilation__MINUSresult)));
return $$TMP600;
}
)(this);
return $$TMP599;
...
$$root["seti!"]($$root["static-compiler-proto"],(new $$root.Symbol("init")),(function(){
   ...
   $$TMP601=(function(self){
      var $$TMP602;
      $$TMP602=(function(root,sandbox,handler,next__MINUSgensym__MINUSsuffix){
         var $$TMP603;
...
r;
$$TMP607=$$root["seti!"](target,name,r);
return $$TMP607;
}
)();
}
...
$$root["seti!"](root,"jeval",(function(s){
   var $$TMP608;
$$TMP608=$$root["call-method-by-name"]($$root["VM"],(new $$root.Symbol("runInContext")),s,sandbox);
return $$TMP608;
}
));
...
$$TMP609=$$root["symbol"]($$root["str"]("__GS",next__MINUSgensym__MINUSsuffix));
return $$TMP609;
}
));
$$TMP603=$$root["call-method"]($$root["geti"]($$root["compiler-proto"],(new $$root.Symbol("init"))),self,root);
return $$TMP603;
}
...
$$root["seti!"]($$root["static-compiler-proto"],(new $$root.Symbol("compile-toplevel")),(function(e){
   ...
   $$TMP610=(function(self){
      var $$TMP611;
      $$TMP611=(function(lexenv){
         var $$TMP612;
         $$TMP612=(function(__GS41){
            var $$TMP613;
            var $$TMP614;
if($$root["matches?"](__GS41,$$root.list(($$root.list(((new $$root.Symbol("quote")) ),((new $$root.Symbol("def")) )) ),((new $$root.Symbol("name")) ),((new $$root.Symbol("val")) )))){
   $$TMP614=(function(__GS42){
      var $$TMP615;
      $$TMP615=(function(name,val){
         var $$TMP616;
         $$TMP616=(function(tmp){
            var $$TMP617;
$$root["seti!"]($$root["geti"](self,(new $$root.Symbol("root"))),name,$$root["make-instance"]($$root["lazy-def-proto"],tmp));
$$TMP617=$$root["str"]($$root["second"](tmp),$$root["first"](tmp),";");
return $$TMP617;
}
)($$root["call-method-by-name"](self,(new $$root.Symbol("compile")),lexenv,e));
return $$TMP616;
}
)($$root["nth"](1,__GS42),$$root["nth"](2,__GS42));
return $$TMP615;
}
)(__GS41);
}
   ...
   var $$TMP618;
if($$root["matches?"](__GS41,$$root.list(($$root.list(((new $$root.Symbol("quote")) ),((new $$root.Symbol("setmac!")) )) ),((new $$root.Symbol("name")) )))){
   $$TMP618=(function(__GS43){
      var $$TMP619;
      $$TMP619=(function(name){
         var $$TMP620;
         $$TMP620=(function(tmp){
            var $$TMP621;
...
$$TMP621=$$root["str"]($$root["second"](tmp),$$root["first"](tmp),";");
return $$TMP621;
}
)($$root["call-method-by-name"](self,(new $$root.Symbol("compile")),lexenv,e));
return $$TMP620;
...
return $$TMP619;
   ...
   var $$TMP622;
if($$root["matches?"](__GS41,$$root.list(($$root.list(($$root.list(((new $$root.Symbol("quote")) ),((new $$root.Symbol("lambda")) )) ),($$root.list(((new $$root.Symbol("&args")) )) ),((new $$root.Symbol("&body")) )) )))){
   $$TMP622=(function(__GS44){
      var $$TMP623;
      $$TMP623=(function(__GS45){
         var $$TMP624;
         $$TMP624=(function(__GS46){
            var $$TMP625;
            $$TMP625=(function(args,body){
               var $$TMP626;
$$TMP626=$$root["join"]("",$$root["map"]($$root["partial-method"](self,(new $$root.Symbol("compile-toplevel"))),body));
return $$TMP626;
}
)($$root["drop"](0,__GS46),$$root["drop"](2,__GS45));
return $$TMP625;
}
)($$root["nth"](1,__GS45));
return $$TMP624;
...
return $$TMP623;
   ...
   var $$TMP627;
if($$root["matches?"](__GS41,$$root.list(((new $$root.Symbol("name")) ),((new $$root.Symbol("&args")) )))){
   $$TMP627=(function(__GS47){
      var $$TMP628;
      $$TMP628=(function(name,args){
         var $$TMP629;
         var $$TMP630;
if($$root["call-method-by-name"](self,(new $$root.Symbol("is-macro")),name)){
$$TMP630=$$root["call-method-by-name"](self,(new $$root.Symbol("compile-toplevel")),$$root["call-method-by-name"](self,(new $$root.Symbol("macroexpand-unsafe")),lexenv,e));
}
else{
   $$TMP630=(function(tmp){
      var $$TMP631;
$$TMP631=$$root["str"]($$root["second"](tmp),$$root["first"](tmp),";");
return $$TMP631;
}
)($$root["call-method-by-name"](self,(new $$root.Symbol("compile")),lexenv,e));
}
...
)($$root["nth"](0,__GS47),$$root["drop"](1,__GS47));
return $$TMP628;
}
)(__GS41);
}
   ...
   var $$TMP632;
if($$root["matches?"](__GS41,(new $$root.Symbol("any")))){
   $$TMP632=(function(any){
      var $$TMP633;
      $$TMP633=(function(tmp){
         var $$TMP634;
$$TMP634=$$root["str"]($$root["second"](tmp),$$root["first"](tmp),";");
return $$TMP634;
}
)($$root["call-method-by-name"](self,(new $$root.Symbol("compile")),lexenv,e));
return $$TMP633;
   ...
   var $$TMP635;
   if(true){
$$TMP635=$$root["error"]("Fell out of case!");
}
else{
   $$TMP635=undefined;
}
...
$$root["seti!"]($$root["static-compiler-proto"],(new $$root.Symbol("compile-unit")),(function(s){
   ...
   $$TMP636=(function(self){
      var $$TMP637;
$$TMP637=$$root["join"]("",$$root["map"]($$root["partial-method"](self,(new $$root.Symbol("compile-toplevel"))),$$root["parse"]($$root["tokenize"](s))));
return $$TMP637;
}
)(this);
return $$TMP636;
